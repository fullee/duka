    ...
    public partial class MainWnd : Form
    {
        ...
        private void buttonReadCard_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Trace.WriteLine("CVR_Authenticate");
                if (authenticate == 1)
                {
                    int readContent = CVRSDK.CVR_Read_Content(4);
                    Trace.WriteLine("CVR_Read_Content: rt"+readContent);
                    if (readContent == 1)
                    {
        ...
        private void buttonOPENCOM_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // MessageBox.Show("hello"+m_Baudrate);
                Trace.WriteLine("CVR_SetComBaudrate");
                if (0 == m_Port)    //usb
                {
